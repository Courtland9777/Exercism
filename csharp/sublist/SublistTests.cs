...
public class SublistTests
{
    ...
    {
        Assert.Equal(SublistType.Sublist,
            Sublist.Classify(new List<int> { 1, 2, 5 }, new List<int> { 0, 1, 2, 3, 1, 2, 5, 6 }));
    }
    ...
    {
        Assert.Equal(SublistType.Sublist,
            Sublist.Classify(new List<int> { 1, 1, 2 }, new List<int> { 0, 1, 1, 1, 2, 1, 2 }));
    }
    ...
    {
        Assert.Equal(SublistType.Sublist,
            Sublist.Classify(new List<int> { 0, 1, 2 }, new List<int> { 0, 1, 2, 3, 4, 5 }));
    }
    ...
    {
        Assert.Equal(SublistType.Sublist,
            Sublist.Classify(new List<int> { 2, 3, 4 }, new List<int> { 0, 1, 2, 3, 4, 5 }));
    }
    ...
    {
        Assert.Equal(SublistType.Sublist,
            Sublist.Classify(new List<int> { 3, 4, 5 }, new List<int> { 0, 1, 2, 3, 4, 5 }));
    }

    [Fact]
    public void At_start_of_superlist()
    {
        Assert.Equal(SublistType.Superlist,
            Sublist.Classify(new List<int> { 0, 1, 2, 3, 4, 5 }, new List<int> { 0, 1, 2 }));
    }
    ...
    {
        Assert.Equal(SublistType.Superlist,
            Sublist.Classify(new List<int> { 0, 1, 2, 3, 4, 5 }, new List<int> { 2, 3 }));
    }
