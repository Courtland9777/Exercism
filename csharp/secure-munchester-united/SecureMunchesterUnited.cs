...
{
    public string GetDisplayName(TeamSupport support) => support is not Staff ?
        "Too Important for a Security Pass" :
        support is not Security ?
        support.Title :
        (support is SecurityJunior or SecurityIntern or PoliceLiaison) ?
        support.Title :
