...
public class ZipperTests
{
    ...
    public void Set_left_with_leaf()
    {
        ...
        var expected = new BinTree(1, new BinTree(2, new BinTree(5, null, null), new BinTree(3, null, null)),
    ...
    public void Set_right_with_subtree()
    {
        ...
        var expected = new BinTree(1, new BinTree(2, null, new BinTree(3, null, null)),
            new BinTree(6, new BinTree(7, null, null), new BinTree(8, null, null)));
        Assert.Equal(expected, actual);
    }
    ...
    public void Different_paths_to_same_zipper()
    {
        ...
        var expected = Zipper
            .FromTree(new BinTree(1, new BinTree(2, null, new BinTree(3, null, null)), new BinTree(4, null, null)))
            .Right();
        Assert.Equal(expected, actual);
    }
}