...
public class HangmanTests : ReactiveTest
{
    ...
    public void After_10_incorrect_guesses_the_game_is_over()
    {
        ...
        // +--x-x-x-x-x-x-x-x-x-x->
        // +a-b-c-d-e-f-g-h-i-j-#
        var testableObserver = scheduler.Start(Create, 100, 100, 3000);
    ...
    public void Correctly_guessing_a_letter_unmasks_it()
    {
        ...
        var expected = new[]
        {
            OnNext<HangmanState>(100,
                hangmanState => hangmanState.RemainingGuesses == 9 && hangmanState.MaskedWord == "______"),
            OnNext<HangmanState>(200,
                hangmanState => hangmanState.RemainingGuesses == 9 && hangmanState.MaskedWord == "___b__"),
            OnNext<HangmanState>(300,
                hangmanState => hangmanState.RemainingGuesses == 9 && hangmanState.MaskedWord == "_oob__")
        };
    ...
    public void Guessing_a_correct_letter_twice_counts_as_a_failure()
    {
        ...
        var expected = new[]
        {
            ...
            OnNext<HangmanState>(200,
                hangmanState => hangmanState.RemainingGuesses == 9 && hangmanState.MaskedWord == "___b__"),
            OnNext<HangmanState>(300,
                hangmanState => hangmanState.RemainingGuesses == 8 && hangmanState.MaskedWord == "___b__")
        };
    ...
    public void Getting_all_the_letters_right_makes_for_a_win()
    {
        ...
        {
            OnNext<HangmanState>(100,
                hangmanState => hangmanState.RemainingGuesses == 9 && hangmanState.MaskedWord == "_____"),
            OnNext<HangmanState>(200,
                hangmanState => hangmanState.RemainingGuesses == 8 && hangmanState.MaskedWord == "_____"),
            OnNext<HangmanState>(300,
                hangmanState => hangmanState.RemainingGuesses == 8 && hangmanState.MaskedWord == "_e___"),
            OnNext<HangmanState>(400,
                hangmanState => hangmanState.RemainingGuesses == 8 && hangmanState.MaskedWord == "_ell_"),
            OnNext<HangmanState>(500,
                hangmanState => hangmanState.RemainingGuesses == 8 && hangmanState.MaskedWord == "_ello"),
    ...
    public void Second_player_sees_the_same_game_already_started()
    {
        ...
        var expected = new[]
        {
            OnNext<HangmanState>(150,
                hangmanState => hangmanState.RemainingGuesses == 9 && hangmanState.MaskedWord == "_e___"),
            OnNext<HangmanState>(200,
                hangmanState => hangmanState.RemainingGuesses == 9 && hangmanState.MaskedWord == "_ell_")
        };
    ...
    private static IDisposable Ready(IObservable<HangmanState> player)
    {
    ...
    public void Player_joins_after_other_players_quit()
    {
        ...
        scheduler.Schedule(TimeSpan.FromTicks(300), () => { hangman.StateObservable.Subscribe(player2); });
